...
#pragma omp parallel private(myid)
 {
  ...
  numprocs = omp_get_num_threads();//vorher1
  myid     = omp_get_thread_num(); //vorher 0
  ...
  //vorher: calc(iterations, width, height, myid, numprocs, xmin, xmax, ymin, ymax, maxiter );
  int curRow;
